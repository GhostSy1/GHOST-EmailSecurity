...
TOOL = "GHOST-EmailSecurity"
VERSION = "2.0.0"
PROFILE = "RFC 5322 header and authentication-result review"
RULES = [('MAIL-AUTH', 'Authentication-Results|Received-SPF|dkim=|spf=|dmarc='), ('MAIL-ROUTE', 'Return-Path|Reply-To|Received:'), ('MAIL-ID', 'Message-ID|From:|To:|Date:')]
...
def render_banner() -> None:
 ...
 | |__| | | | | |__| | |__| || |_
  \_____|_| |_|\____/ \____/_____|
      GHOST-EmailSecurity v2.0-PRO (Zero-Guessing Engine)
"""
    print(banner)
